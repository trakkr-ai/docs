...
<Info>
  Sentiment analysis is available to users on all plans. Head to the [plans page](/plans) to learn more.
</Info>
...
<CardGroup cols={2}>
  ...
  <Card title="Working with Prompts" icon="message-question" href="/working-with-prompts" color="#0e9373">
    Create prompts that help you track sentiment across different contexts
  </Card>
