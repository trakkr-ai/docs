...
<Info>
  Crawler analytics is available to users on all plans. Head to the [plans page](/plans) to learn more.
</Info>
...
Crawler Analytics is part of Trakkr's comprehensive tracking suite. Combine it with other features for complete AI visibility:

<CardGroup cols={2}>
  <Card title="Google Analytics" icon="chart-line" href="/google-analytics" color="#0e9373">
    Track actual user traffic from AI sources to see conversion and engagement
  </Card>

  <Card title="Understanding Scores" icon="chart-bar" href="/understanding-scores" color="#0e9373">
    See how crawler activity correlates with your Visibility and Presence scores
  </Card>

  <Card title="Competitors" icon="users" href="/competitors" color="#0e9373">
    Compare your crawler activity with competitive positioning data
  </Card>

  <Card title="Technical Audit" icon="wrench" href="/technical-audit" color="#0e9373">
    Ensure your site is optimized for the crawlers visiting you
  </Card>
</CardGroup>

<Tip>
  **Best practice**: High crawler activity but low visibility scores? Run a [Technical Audit](/technical-audit) to ensure crawlers can properly understand your content.
</Tip>