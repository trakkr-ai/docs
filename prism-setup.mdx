...
<Steps>
  <Step title="Create a KV namespace">
    This is a small, lightning fast database that lives in Cloudflare)
  </Step>
  ...
  <Step title="Bind the namespace to the worker">
...
Head [here](https://dash.cloudflare.com/bdcc83ce4fc5e1e3d0e0167d1e385329/workers/kv/namespaces), and create a namespace/instance called TRAKKR_KV.
...
- **Required**\
  You must change the allowed domains in step 1 to match your domains. We recommend including both the root and www. domain for safety.
- **Optional**\
