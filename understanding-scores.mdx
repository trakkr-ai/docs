...
Understanding your scores is just the beginning. Here's how to actually improve them:

<CardGroup cols={2}>
  <Card title="Technical Audit" icon="wrench" color="#0e9373" href="/technical-audit">
    **Start here**: Fix crawlability and technical issues affecting AI understanding
  </Card>
  <Card title="Optimize Content" icon="sparkles" color="#0e9373" href="/optimize-content">
    Get page-specific recommendations to boost rankings and visibility
  </Card>
  <Card title="Working with Prompts" icon="message-question" color="#0e9373" href="/working-with-prompts">
    Create better prompts that capture your true market position
  </Card>
  <Card title="Prompt Research" icon="magnifying-glass" color="#0e9373" href="/prompt-research">
    Discover 500+ relevant queries to expand your tracking
  </Card>
</CardGroup>
...
<CardGroup cols={2}>
  <Card title="Reading Reports" icon="file-chart-line" color="#0e9373" href="/reading-reports">
    Master your dashboard and track performance trends
  </Card>
  <Card title="Competitors" icon="users" color="#0e9373" href="/competitors">
    See how your scores compare to competitor performance
  </Card>
  <Card title="Citations" icon="quote-left" color="#0e9373" href="/citations">
    Understand which sources influence your visibility
  </Card>
  <Card title="Sentiment Analysis" icon="heart" color="#0e9373" href="/sentiment-analysis">
    Track qualitative perceptions alongside quantitative scores
  </Card>
</CardGroup>