...
<Warning>
  **Traffic Analytics is deprecated.** This feature is only available on older accounts. New users should use [Google Analytics integration](/google-analytics) instead, which provides more comprehensive traffic tracking from AI sources.
</Warning>
