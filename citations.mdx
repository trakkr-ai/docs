...
You can connect the [Byword integration](/byword) to pull these Search Queries straight into Byword's article and campaign creation flows. Import queries and insert them as Keywords or Titles with one click.
