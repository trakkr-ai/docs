...
<Info>
  Outreach is available on paid plans only. It requires Citations data to identify opportunities. [Upgrade to access](/plans)
</Info>
...
<Card title="Content Optimization" icon="sparkles" href="/optimize-content" color="#0e9373">
