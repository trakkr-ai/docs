...
To enable overage billing, you must also set a spend cap. This spend cap increases your limit from the base 10,000 crawler requests per month. 

So for example, if your spend cap is \$100, your new request limit will be 30,000 crawler requests per month. This is because you get 10,000 requests for free, and $100 divided by $5 gives 20, or an extra 20,000 requests (10,000 \+ 20,000 = 30,000 total request limit).

<Frame>
  Request Limit = 10,000 \+ ( ( Spend Cap / 5 ) \* 1,000 )
</Frame>