...
<CardGroup cols={3}>
  ...
  <Card title="Growth" icon="rocket">
    **\$49** per month
    ...
    For brand owners ready to track AI performance
  </Card>
  <Card title="Scale" icon="building">
    **\$249** per month

    For agencies and teams with multiple brands
  </Card>
</CardGroup>

<Tip>
  **Save with annual billing**: Growth at $490/year (save $98) or Scale at $2,490/year (save $498)
</Tip>
